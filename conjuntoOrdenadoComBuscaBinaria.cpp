//Implemente em C++ um conjunto limitado via vetor ordenado,
//utilizando na função "pertence" o algoritmo de busca binária 
//discutido em sala. Inclua as funções vazio e cheio.
...
int buscaBin(Conjunto &C, char elemento){
    int inicio = 0;
    int fim = C.n - 1;
    while(inicio <= fim){
